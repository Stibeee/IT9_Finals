<div id="blog" class="py-5 text-center container-fluid bg-dark text-light wow fadeIn">
    ...
    @endif
    <h2 class="py-5 section-title">Find your Best Coffee</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="my-3 bg-transparent border card my-md-0">
                        ...
                        <img height="200" src="coffee_img/{{ $coffees->image }}" class="rounded-0 card-img-top mg-responsive">

                        <div class="card-body">
                            <h1 class="mb-4 text-center">
                                <a href="#" class="badge badge-primary">₱{{ $coffees->price }}</a>
                            </h1>

                            <div style="position: relative; text-align: center;" class="mb-4 pt20 pb20">
                                <h4 style="margin: 0;">{{ $coffees->coffee_title }}</h4>
                                <div style="position: absolute; right: 0; top: 50%; transform: translateY(-50%); display: flex; align-items: center;">
                                    @if($coffees->availability)
                            ...
                            <p class="mb-4 text-center text-white">{{ $coffees->detail }} </p>
                        </div>

                        <div style="display: flex; justify-content: center; align-items: center; margin-top: 50px;"> 
                            @if($coffees->availability) 
                                <form action="{{url ('add_cart', $coffees->id) }}" method="POST" style="display: flex; gap: 10px;"> 
                                    @csrf 
                            ...
                            @else 
                                <div class="alert alert-danger" style="margin: 0; border-radius: 50px;"> 
                                    This coffee is currently unavailable.
                                </div> 
                            @endif 
                        </div>
                        <br><br><br>
