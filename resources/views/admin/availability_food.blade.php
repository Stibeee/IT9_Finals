...
<body>
    ...
    <div class="page-content">
        <div class="container-fluid">
            <h1 class="text-white mb-4;">Food Availability</h1>
                ...
                <tbody>
                    @foreach ($food as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.toggle_food_availability', $item->id) }}" 
                            ...
                            <td>
                                <img src="{{ asset('food_img/' . $item->image) }}" width="80" height="80" class="rounded">
                            </td>
                        </tr>
                    @endforeach
                </tbody>
